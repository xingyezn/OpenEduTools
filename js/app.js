(function (root) {
  'use strict';
  const state = { tools: [], query: '', category: 'all', onlyFavorites: false };
  ...
  function initCatalog(data) {
    ...
    function render() {
      const filtered = root.OETSearch.filterTools(state.tools, { query: state.query, category: state.category, onlyFavorites: state.onlyFavorites, favorites: favoriteIds });
