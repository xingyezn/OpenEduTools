...
const { normalizeQuery, filterTools, categoryCounts } = require('../js/search.js');
...
const tools = [
  { id: 'a', name: '随机点名', description: '课堂抽取学生', tags: ['随机', '名单'], category: 'classroom-management' },
  { id: 'b', name: '成绩统计', description: '计算平均分', tags: ['成绩', '数据'], category: 'assessment' }
];
